...
getLibDir = catchIO (getEnv "AI_nPuzzle_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "AI_nPuzzle_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "AI_nPuzzle_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "AI_nPuzzle_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "AI_nPuzzle_sysconfdir") (\_ -> return sysconfdir)
