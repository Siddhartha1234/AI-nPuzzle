...
/* package AI-nPuzzle-0.1.0.0 */
#define VERSION_AI_nPuzzle "0.1.0.0"
#define MIN_VERSION_AI_nPuzzle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "AI-nPuzzle-0.1.0.0-G3wrCDuLjfk4CwJfKTrUb4"

#define CURRENT_PACKAGE_KEY "AI-nPuzzle-0.1.0.0-G3wrCDuLjfk4CwJfKTrUb4"
